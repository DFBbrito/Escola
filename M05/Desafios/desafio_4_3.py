...
Cada jogador lança o dado 6 vezes e o programa deve guardar os resultados num dicionário em que o nome do jogador é a chave. 
No final o programa deve indicar quem ganhou o jogo que corresponde ao jogador com o total de valores mais elevado. 
O valor do lançamento do dado deve ser simulado com a library random."""
